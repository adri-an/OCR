# -*- coding: utf-8 -*-
"""
Created on Sun Mar  6 22:54:47 2016
...
def carImg(imagen,opcion):  #Inicialización de la función  
    ...
    if opcion==1: #Si el parámetro de opción es igual a uno se obtienen las características de las imagenes del dataset
        return num_unos, total, ancho_mitad, ancho_cuarto, ancho_3cuartos, alto_mitad, alto_cuarto, alto_3cuartos, contador_c1, contador_c2, contador_c3, contador_ca1, contador_ca2, contador_ca3,clase #Se regresan las 15 características y la clase de la imagen
...
dat = matriz_data #Datos obtine el valor de la matriz con las características de las imagenes
csv_salida = open('knn.csv', 'w', newline='') #Crea y abre el archivo csv 
salida = csv.writer(csv_salida) #Índica que se escribirán datos en el csv
salida.writerows(dat) #Escribe los datos de la lista en el documento csv
...
dos=0 #Se inicializa el contador de los dos
...
for i in range(size_matriz): #Se crea un for para ir almacenando el número de instancias de cada clase
    if matriz_data[i][14]=='0': #Si el elemento señalado en dicha posición es igual a cero 
        ...
        nueve_ins=nueve_ins+1           # Se incrementa el contador de los nueves
